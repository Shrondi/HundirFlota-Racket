  ...
  (let
    ...
    (cond
      ((string-ci=? label "Desanclar")
       ...
       (send boton-anclar/desanclar-jugador set-label "Anclar")
       )
      ((string-ci=? label "Anclar")
       ...
       ;;(send boton-anclar/desanclar-jugador set-label "📌")
       (send boton-anclar/desanclar-jugador set-label "Desanclar")
       )
      )
    )
  )
  ...
  (let
    ...
    (cond
      ((string-ci=? label "Desanclar")
       ...
       (send boton-anclar/desanclar-CPU set-label "Anclar")
       )
      ((string-ci=? label "Anclar")
       ...
       ;;(send boton-anclar/desanclar-CPU set-label "📌")
       (send boton-anclar/desanclar-CPU set-label "Desanclar")
       )
      )
    )
  )
